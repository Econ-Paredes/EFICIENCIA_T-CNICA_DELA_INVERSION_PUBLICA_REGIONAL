...
Este repositorio contiene la base de datos procesada y la totalidad de los scripts desarrollados en **R** y **Stata** utilizados en la tesis de maestría titulada:
